<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentRegistration.aspx.cs" Inherits="AAITschool.StudentRegistration" %>
...
<body>
    ...
    <asp:HiddenField ID="hdClassID" runat="server"></asp:HiddenField>
        <div>
           ...
           &nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="ddlTeacher" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlTeacher_SelectedIndexChanged" Visible="False"></asp:DropDownList>    
    <br />
    <br />
